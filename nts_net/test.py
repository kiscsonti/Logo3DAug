...
from nts_net.config import BATCH_SIZE, PROPOSAL_NUM, test_model
from nts_net.core import model, dataset
from nts_net.core.utils import progress_bar
...
# define model
net = model.AttentionNet(top_n=PROPOSAL_NUM)
